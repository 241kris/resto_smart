...
import { ShoppingCart, MapPin, Phone, Mail, Loader2, Minus, Plus, Receipt, Star, Tag, Sparkles, TrendingUp, Flame, Award, ChefHat } from "lucide-react"
    ...
    return (
      <div className="min-h-screen flex items-center justify-center p-4">
        <div className="text-center max-w-md">
          ...
          <h2 className="text-sm font-semibold mb-2">Erreur</h2>
        ...
        <div className="bg-gradient-to-br from-amber-50 to-orange-50 py-6 border-b">
          <div className="container mx-auto px-4">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h2 className="text-sm font-semibold text-amber-900">Plats du Jour</h2>
            </div>
